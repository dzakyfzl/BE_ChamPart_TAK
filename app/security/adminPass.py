...
def generate_pass(unique:str, nama_instansi:str) -> str:
    passkey = unique + nama_instansi + SECRET_KEY
    return hashlib.sha256(passkey.encode('utf-8')).hexdigest()

def verif_pass(unique:str, nama_instansi:str, existed_passkey:str) -> bool:
    passkey = unique + nama_instansi + SECRET_KEY
